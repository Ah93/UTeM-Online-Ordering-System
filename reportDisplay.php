...
<form class="form-horizontal" id="form_members" role="form" method="post" action="supupdate.php">
  ...
  <hr>
  <p></p>
  <table id="report" class="table table-bordered" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th class="col-sm-1">Report ID</th>
                <th class="col-sm-1">Sender Name</th>
                <th class="col-sm-1">Email</th>
				 <th class="col-sm-1">OCCUPATION</th>
...
?>
	  ...
	  <td><a href='repEdit.php?sid=<?php echo $objResult["REPORTID"]?>' class='btn btn-warning'>
	  <span class='glyphicon glyphicon'></span>Response</a></td>
	  <td><a href='deleteRep.php?sid=<?php echo $objResult["REPORTID"]?>' class='btn btn-danger'>
	  <span class='glyphicon glyphicon'></span>Delete</a></td>
	  <?php
