...
<div style="width:300px;float:right;text-align:right">
	  <a href='exportStudent.php' class='btn btn-primary'>
  ...
  <p></p>
  <table id="student" class="table table-bordered" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
